...
public class WidgetCardView: UIView {
    ...
    private func setPaddingTextField(bottomDate: String,topDate: String,leadCvv: String,leadDate: String,BottomCvv: String,trailDate: String,TrailCvv: String,topCardNo: String,BottomCardNo: String,cvvTop: String,cardNoLeft: String,cardNoRight: String,validthruLead: String,validthruTrail: String,validthrutop: String,validthrubottom: String){
...
extension WidgetCardView  {
    ...
    private func getCardDetails(body: [String : Any]) {
    ...
    private func decrypt(accountNo: String,cvv: String,expiry: String){
        do {
